...
than exceeding L16--23. The base recall at $n{=}150$ is $0.620$ $[0.54, 0.69]$; the
$n{=}30$ estimate of $0.53$ fell on the low side of the sampling distribution, but
the intervention deltas on which our claims rest are preserved. We report $n{=}30$
as the primary regime throughout and treat this table as statistical confirmation.
...
The full sweep (Table~\ref{tab:main}, Figure~\ref{fig:layers}) compares all four interventions across
